...
3. trend — SP 맛 묘사를 첫 문장에 자연스럽게 녹여서 시작하는 대세감 단락. 2-3문장.
   반드시 "연일 품절대란이 이어지고 있습니다."로 끝낼 것.
   예시: 입력SP가 "딸기 씨가 톡톡 씹혀 상큼달달 그 자체"면
   → "딸기 씨가 톡톡 씹혀 상큼달달 그 자체라는 후기가 입소문 나면서 출시 직후부터 품절 대란이 시작됐습니다. 연일 품절대란이 이어지고 있습니다." 처럼 시작.
